...
c	Local variables:
	...
	real            qual1, qual2
        ...
        write(log,'("~ getting synthetic data files for Vp and Vs data...")')

c	a=0.1 ! Control the constant noise level
c	b=0.2 ! Control the random noise level for P wave
c	c=0.2 ! Control the random noise level for S wave
